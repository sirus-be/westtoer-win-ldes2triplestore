...
SELECT DISTINCT ?winId ?wijzigingsdatum ?beschrijving ?naam ?typeLabels ?status ?faciliteiten ?huisnummer ?straatnaam ?gemeente ?provincie ?postcode ?niscode ?website ?email ?telefoonnummers ?lat ?long ?toeristischeregioTVLId ?toeristischeregioLabel ?product ?wkt
WHERE {
